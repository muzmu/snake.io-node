...
function call_me() {
    ...
    setInterval(!alive || game,1000/10);
}
...
function sned(){
	socket.emit('start_game' , 1)
}

//call_me()

socket.on("start", (data,x_c,y_c) => {
	...
	if(data==1){
		...
		ReactDOM.render(React.createElement('div',{},
		        ...
		        React.createElement('button',{onClick : sned,style : {marginLeft:'50%',width : 130,height : 70,fontSize: 20}},'Let\'s Play'))
	...
	if(data==3){
	 ...
	 if(data == 5){
        ...
        ReactDOM.render(React.createElement('div',{},
        React.createElement('h3',{style:{textAlign : "Center",fontSize: 100}},'WELCOME TO SNAKE'),
        React.createElement('div',{style : {marginLeft:'23%',fontSize:75}},'Congratulations'),
        React.createElement('div',{style : {marginLeft:'23%',fontSize:75}},'CHAMP'))
        ,document.getElementById('root1'))
    }
