...
to_send = {id : my_id ,px: px , py:py , xv : xv , yv: yv ,position: trail}

socket.on("id", data=> {
    my_id = data;
})

socket.on("positions", (i,data) => {
    all_trails = data;
    ctx.fillStyle = "yellow"
    data.map(one_piece=> ctx.fillRect(one_piece.x*gs,one_piece.y*tc,gs-15,gs-15))
})
